                                        ...
                                        @if(!empty($chosenEventData))
                                            <div class="sm:col-span-12 flex relative pt-2">
                                                ...
                                                <div class="sm:col-span-6">
                                                    ...
                                                    <div class="mt-2">
                                                        <input type="text" wire:model="quantity" placeholder="Verfügbare Anzahl" class="block min-w-375 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                                    </div>
                                                    @error('quantity')
                                                    <div class="my-2 flex items-center bg-red-700 text-white text-sm font-bold px-4 py-3" role="alert">
                                                ...
                                                <div class="sm:col-span-6 ml-3">
                                                    ...
                                                    <div class="mt-2">
                                                        <select id="split" name="split" class="block min-w-375 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                            ...
                                            <div x-data="{ originalpreis: 0, brokerPrice: 0, websitePrice: 0}" class="col-span-full pt-2" x-effect="websitePrice = Math.round((brokerPrice)/(brokerPrice - 25)*100)">
                                                <div class="flex relative">
                                                    <div class="col-span-4 flex">
                                                        <label for="email" class="pr-2 pt-3 block text-sm font-medium leading-6 text-gray-900">Originalpreis</label>
                                                        <div class="mt-2">
                                                            <input x-model.number="originalpreis" wire:model="faceValue" type="text" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" value="0.00" placeholder="Originalpreis"
                                                                   class="block  w-32 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                                        </div>
                                                        @error('faceValue')
                                                        <div class="my-2 flex items-center bg-red-700 text-white text-sm font-bold px-4 py-3" role="alert">
                                                            <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                                    ...
                                                    <div class="col-span-4 px-6 flex">
                                                        <label for="street-address" class="px-1 pt-3 block text-sm font-medium leading-6 text-gray-900">Ihre Auszahlung</label>
                                                        <div class="mt-2">
                                                            <input x-model.number="brokerPrice" wire:model="brokerPrice" type="text"
                                                                   onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" value="0.00" placeholder="Ihre Auszahlung"
                                                    ...
                                                    <div class="col-span-4 flex">
                                                        ...
                                                        <div class="mt-2">
                                                            <input x-model.number="websitePrice" wire:model="websitePrice" type="text" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)"
                                                                   value="0.00" placeholder="Ticket-Gesamtpreis"
                                                                   class="block bg-indigo-300 w-32 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                                                   readonly disabled>
                                                        </div>
                                                        @error('websitePrice')
                                                        <div class="my-2 flex items-center bg-red-700 text-white text-sm font-bold px-4 py-3" role="alert">
...
--}}
                                            ...
                                            <div class="col-span-full relative flex relative pt-5" x-data="{impaired : []}">
                                                ...
                                                {?><input type="radio" class="block text-sm font-medium leading-6 text-black justify-between mr-2" wire:model="choice"  value="<?php echo $x_value ?>" required><?php echo $x ?><br /><?php }?>
                                                @error('choice')
                                                <div class="my-2 flex items-center bg-red-700 text-white text-sm font-bold px-4 py-3" role="alert">
                                                    <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.432 0c1.34 0 2.01.912 2.01 1.957 0 1.305-1.164 2.512-2.679 2.512-1.269 0-2.009-.75-1.974-1.99C9.789 1.436 10.67 0 12.432 0zM8.309 20c-1.058 0-1.833-.652-1.093-3.524l1.214-5.092c.211-.814.246-1.141 0-1.141-.317 0-1.689.562-2.502 1.117l-.528-.88c2.572-2.186 5.531-3.467 6.801-3.467 1.057 0 1.233 1.273.705 3.23l-1.391 5.352c-.246.945-.141 1.271.106 1.271.317 0 1.357-.392 2.379-1.207l.6.814C12.098 19.02 9.365 20 8.309 20z"/></svg>
                                                    <p class="text-white">{{ $message }}</p>
