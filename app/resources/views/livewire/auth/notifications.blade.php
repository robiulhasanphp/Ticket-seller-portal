                                        ...
                                        <div class="max-w-lg">
                                            <div class="mt-4 space-y-4">
                                                <div class="flex items-center">
                                                    ...
                                                    {?><input type="radio" class="ml-3 block text-sm font-medium leading-6 text-black justify-between mr-2" wire:model="choice"  value="<?php echo $x_value ?>" required><?php echo $x ?><br /><?php }?>
                                                    @error('choice')
