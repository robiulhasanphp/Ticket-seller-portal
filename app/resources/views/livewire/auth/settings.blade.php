                    ...
                    <div class="pt-8">
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            <div class="sm:col-span-6">
                                ...
                                <select  id ="onchange"  onchange="ShowHideDiv()" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6" name="accountType" required>
                                    <?php
                            ...
                            <div id="commercial" class="sm:col-span-6" x-cloak>
                                <div class="sm:col-span-3" >
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="vat_id" value="@if(!empty($vat_id)){{$vat_id}}@endif"  class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Identifikationsnummer" required>
                                    </div>
                                </div>
                                <div class="sm:col-span-3">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-2">
                                    <textarea  name="agb_seller_message" rows="6" class="text-left text-sm font-medium leading-6 block w-full rounded-md border-gray-300  text-black shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6" required>
