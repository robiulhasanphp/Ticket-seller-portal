                                                                ...
                                                                <div class="border-b border-white/10">
                                                                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                                                        ...
                                                                        <div class="col-span-full">
                                                                            ...
                                                                            <div class="mt-2">
                                                                                <textarea id="about" name="message" rows="3" placeholder="Schreibe deine Nachricht hier.." class="block w-full rounded-md border-gray-300  py-1.5 text-black shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"></textarea>
                                                                            </div>
                                                                        </div>
