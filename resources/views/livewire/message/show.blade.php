                ...
                <div class="w-72 ">
                    <div x-data="{ openNewMessage: false }" class="flex mx-6">
                        ...
                        <select onchange="addLoadingClass()" class="ml-2 px-6 w-40 my-4 bg-red-700 flex items-center rounded justify-between pb-2 pt-2.5 text-xs text-white" wire:change="getConversationByType($event.target.value)" name="conversation_types">
                            ...
                            <option value="open" selected>Offene</option>
                        </select>
                    ...
                    <div class="mb-3 mx-6 ">
                        <div class="w-full relative mb-4 flex  flex-wrap items-stretch">
                            <input wire:model.debounce.500ms="suchen" type="search" class="w-20 relative m-0 -mr-0.5 block w-[1px] min-w-0 flex-auto rounded-l border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-[0.25rem] "
                                        ...
                                        <div class="chat-message ml-60 ">
                                            <div class="flex items-end">
                                                <div
                                                    ...
                                                    <div>
                                                        <span class="px-4 py-2 rounded-lg inline-block text-xs rounded-bl-none bg-red-500 text-white">{!! $conversation['message'] !!}</br><span class="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-cyan-300 text-red-600">@if($conversation['user_type'] == 'admin'){{'Ticketbande'}} @else {{$conversation['author_name']}}@endif,{{$conversation['created_at_formatted']}}</span></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if( $conversation['message_type'] == 'receiver')
                                        <div class="chat-message">
                                            <div class="flex items-end justify-end">
                                                <div
                                                    class="flex w-2/3 flex-col space-y-2 text-xs w-fit mx-2 order-2 items-end bg-red-600">
                                                    <div>
                                                        <span class="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">{!! $conversation['message'] !!}</br><span class="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-cyan-300 text-red-600">@if($conversation['user_type'] == 'admin'){{'Ticketbande'}} @else {{$conversation['author_name']}}@endif,{{$conversation['created_at_formatted']}}</span></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mt-2">
                                ...
                                <div id="textArea">
                                    ...
                                    <div id="tabs-1-panel-2" class="-m-0.5 rounded-lg p-0.5" aria-labelledby="tabs-1-tab-2" role="tabpanel" tabindex="0">
                                        <div class="border-b">
                                            <button type="submit" onclick="addLoadingClass()"  class="rounded-md w-80 bg-indigo-500 px-10 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                                Senden
                                            </button>
                                        </div>
                                    </div>
