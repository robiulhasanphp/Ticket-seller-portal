<x-guest-layout>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center  mx-4 pt-0 sm:pt-0">
        <!-- Session Status -->
        <form id="form" method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <input placeholder="E-mail" class="block mt-1 w-full text-black" type="email"  name="email"/>
                @error('email')
